        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="{{route('dashboard.shippingMethods.create')}}" class="btn btn-success">
                        <i class="ri-add-line align-bottom me-1"></i>@lang('admin.shippingMethods.add')</a>
                </div>
                <div class="card-body">
                    <table id="buttons-datatables" class="display table table-bordered" style="width:100%">
                        ...
                        <tr>
                            ...
                            <th>@lang('admin.shippingMethods.name')</th>
                            <th>@lang('admin.image')</th>
                            <th>@lang('admin.email')</th>
                            <th>@lang('admin.status')</th>
                            <th>@lang('admin.banned')</th>
                        ...
                        @forelse($shippingMethods as  $shippingMethod)
                            <tr>
                                ...
                                <td>{{$shippingMethod->translations[0]->name}}</td>

                                <td><img src="{{ $shippingMethod->logo }}" alt="{{ $shippingMethod->logo }}" height="70" width="50">
                                </td>
                                <td>{{$shippingMethod->email}}</td>
                                <td>
                                    @if($shippingMethod->status == 'active')
                                        <span class="badge badge-soft-primary">@lang('admin.active')</span>
                                    @else
                                        <span class="badge badge-soft-danger">@lang('admin.inactive')</span>
                                    @endif
                                </td>
                                <td>
                                    @if($shippingMethod->banned == 1)
                                        <span class="badge badge-soft-danger">@lang('admin.yes')</span>
                                    @else
                                        <span class="badge badge-soft-success">@lang('admin.no')</span>
                                    @endif
                                </td>
                                <td>
                                    <div class="dropdown d-inline-block">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end " data-popper-placement="top-end"
                                            ...
                                            <li><a href="{{route('dashboard.shippingMethods.edit',$shippingMethod->id)}}"
                                            ...
                                            <li class="list-inline-item" data-bs-toggle="tooltip"
                                                ...
                                                <a class="text-danger dropdown-item edit-item-btn" data-bs-toggle="modal" href="#deleteCategory-{{ $shippingMethod->id }}">
                                                    <i class="ri-delete-bin-5-fill fs-16"></i>  @lang('admin.delete')
                                                </a>
                                            </li>
                                            <li><a href="{{route('dashboard.shippingMethod.banned',$shippingMethod->id)}}"
                                                   class="dropdown-item edit-item-btn"><i
                                                        class="ri-check-fill align-bottom me-2 text-danger"></i>
                                                    @lang('admin.ban')</a></li>
                            ...
                            <div class="modal fade flip"
                                 id="deleteCategory-{{ $shippingMethod->id }}"
                                        ...
                                        <div class="modal-body p-5 text-center">
                                            ...
                                            <div class="mt-4 text-center">
                                                ...
                                                <div class="hstack gap-2 justify-content-center remove">
                                                    ...
                                                    <form action="{{route('dashboard.shippingMethods.destroy',$shippingMethod->id)}}"
                                                          method="post">
                                                        @csrf
                                                        @method("DELETE")
                                                        <button type="submit"
