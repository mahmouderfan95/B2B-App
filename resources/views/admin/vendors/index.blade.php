                ...
                <div class="card-body">
                    <table class="table table-nowrap align-middle" id="productsTable">
                        ...
                        <tr class="text-uppercase">
                            <th>@lang('admin.vendors.id')</th>
                            <th>@lang('admin.vendors.name')</th>
                        ...
                        @forelse($vendors as  $vendor)
                            <tr>
                                <td>{{$vendor->id}}</td>
                                <td>{{$vendor->name}}</td>
                                <td><img src="{{ $vendor->logo }}" alt="{{ $vendor->name }}" height="70" width="50">
                                </td>
                                <td>{{$vendor->phone}}</td>
                                <td>{{$vendor->email}}</td>
                                <td> @if($vendor->status == 'approved')
                                ...
                                <td>
                                    <div class="dropdown d-inline-block">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end " data-popper-placement="top-end"
                                            ...
                                            <li><a href="{{route('dashboard.vendors.edit',$vendor->id)}}"
                                                   class="dropdown-item edit-item-btn"><i
                                                        class="ri-pencil-fill align-bottom me-2 text-muted"></i>
                                                    @lang('admin.edit')</a></li>
                                            <li><a href="{{route('dashboard.vendor.banned',$vendor->id)}}"
                                                   class="dropdown-item edit-item-btn"><i
                                           ...
                                           {{-- <li class="list-inline-item" data-bs-toggle="tooltip"
                                                ...
                                                <a class="text-danger dropdown-item edit-item-btn"
                                                   data-bs-toggle="modal" href="#deleteCategory-{{ $vendor->id }}">
                                    ...
                                    <div class="modal-content">
                                        <div class="modal-body p-5 text-center">
                                            ...
                                            <div class="mt-4 text-center">
                                                <h4>@lang('admin.vendors.delete_modal.title')</h4>
                                                <p class="text-muted fs-15 mb-4">@lang('admin.vendors.delete_modal.description')</p>
                                                <div class="hstack gap-2 justify-content-center remove">
                                                    ...
                                                    <form action="{{route('dashboard.vendors.destroy',$vendor->id)}}"
                                                          method="post">
                                                        @csrf
                                                        @method("DELETE")
                                                        <button type="submit"
