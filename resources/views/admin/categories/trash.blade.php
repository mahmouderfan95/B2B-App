...
@section('title')
    @lang('admin.categories.categories_deleted')
@endsection
@section('css')
    <!--datatable css-->
                    ...
                    <table id="buttons-datatables" class="display table table-bordered" style="width:100%">
                        ...
                        @forelse($trashes as  $category)
                            <tr>
                                ...
                                <td>
                                    <a href="{{route('dashboard.category.restore',$category->id)}}"
                                       class="dropdown-item edit-item-btn"><i
                                            class="ri-rotate-lock-fill align-bottom me-2 text-muted"></i>
                                        @lang('admin.restore')</a>
