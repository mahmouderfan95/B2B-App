...
{{--                <div class="card-header">
                    ...
                    <a href="{{route('dashboard.reviews.create')}}" class="btn btn-success">
                        <i class="ri-add-line align-bottom me-1"></i>@lang('admin.reviews.add')</a>
                </div>--}}
                <div class="card-body">
                    <table id="buttons-datatables" class="display table table-bordered" style="width:100%">
                        <thead class="text-muted table-light">
                        <tr>
                            <th>@lang('admin.reviews.id')</th>
                            <th>@lang('admin.reviews.client')</th>
                            <th>@lang('admin.reviews.product')</th>
                        ...
                        @forelse($reviews as  $review)
                            <tr>
                                ...
                                <td>{{$review->product->translations[0]->name}}</td>
                                <td>{{$review->rate}}</td>
                                <td> @if($review->status == 'accepted')
                                ...
                                <td>
                                    <div class="dropdown d-inline-block">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end " data-popper-placement="top-end"
                                            ...
                                            <li><a href="{{route('dashboard.reviews.edit',$review->id)}}"
                                            ...
                                            <li class="list-inline-item" data-bs-toggle="tooltip"
                                                ...
                                                <a class="text-danger dropdown-item edit-item-btn"
                                                   data-bs-toggle="modal" href="#deleteCategory-{{ $review->id }}">
                                    ...
                                    <div class="modal-content">
                                        <div class="modal-body p-5 text-center">
                                            ...
                                            <div class="mt-4 text-center">
                                                <h4>@lang('admin.reviews.delete_modal.title')</h4>
                                                <p class="text-muted fs-15 mb-4">@lang('admin.reviews.delete_modal.description')</p>
