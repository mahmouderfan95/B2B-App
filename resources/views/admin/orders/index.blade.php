...
@section('title')
    @lang('admin.orders.orders_sample')
@endsection
@section('css')
    <!--datatable css-->
            ...
            <div class="col-xxl-4 col-sm-6">
                <div class="search-box">
                    <select name="status" class="form-select" dir="rtl" data-choices
                        ...
                        <option value="in_shipping">@lang('admin.orders.orderStatus.in_shipping')</option>
                        <option value="in_shipping">@lang('admin.orders.orderStatus.in_delivery')</option>
