        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="{{route('dashboard.certificates.create')}}" class="btn btn-success">
                        <i class="ri-add-line align-bottom me-1"></i>@lang('admin.certificates.add')</a>
                </div>
                <div class="card-body">
                    <table id="buttons-datatables" class="display table table-bordered" style="width:100%">
                        <thead class="text-muted table-light">
                        <tr>
                            <th>@lang('admin.certificates.id')</th>
                            <th>@lang('admin.image')</th>
                            <th>@lang('admin.certificates.name')</th>
                        ...
                        @forelse($certificates as  $certificate)
                            <tr>
                                ...
                                <td><img src="{{ $certificate->image }}" alt="{{ $certificate->name }}" height="70" width="50"></td>
                                <td>{{$certificate->translations[0]->name}}</td>
                                ...
                                <td>
                                    <div class="dropdown d-inline-block">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end " data-popper-placement="top-end"
                                            ...
                                            <li><a href="{{route('dashboard.certificates.edit',$certificate->id)}}"
                                            ...
                                            <li class="list-inline-item" data-bs-toggle="tooltip"
                                                ...
                                                <a class="text-danger dropdown-item edit-item-btn" data-bs-toggle="modal" href="#deleteCategory-{{ $certificate->id }}">
                            ...
                            <div class="modal fade flip"
                                 id="deleteCategory-{{ $certificate->id }}"
                                    ...
                                    <div class="modal-content">
                                        <div class="modal-body p-5 text-center">
                                            ...
                                            <div class="mt-4 text-center">
                                                <h4>@lang('admin.certificates.delete_modal.title')</h4>
                                                <p class="text-muted fs-15 mb-4">@lang('admin.certificates.delete_modal.description')</p>
                                                <div class="hstack gap-2 justify-content-center remove">
                                                    ...
                                                    <form action="{{route('dashboard.certificates.destroy',$certificate->id)}}"
                                                          method="post">
                                                        @csrf
                                                        @method("DELETE")
                                                        <button type="submit"
