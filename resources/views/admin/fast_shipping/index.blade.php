            ...
            <div class="card">
                @if (count($data) == 0)
                    <div class="card-header">
                        ...
                        <a href="{{ route('dashboard.fast-shipping.create') }}" class="btn btn-success">
                            <i class="ri-add-line align-bottom me-1"></i>@lang('admin.fast_shipping.add')</a>
                    </div>
                @endif
                <div class="card-body">
                    <table id="buttons-datatables" class="display table table-bordered" style="width:100%">
                        <thead class="text-muted table-light">
                            <tr>
                                <th>@lang('admin.fast_shipping.fast_shipping')</th>
                                <th>@lang('admin.actions')</th>
                            </tr>
                        </thead>
                        <tbody>

                            @forelse($data as  $fastShipping)
                                <tr>
                                    <td>{{ $fastShipping->translations[0]->content }}</td>

                                    <td>
                                        <a href="{{ route('dashboard.fast-shipping.edit', $fastShipping->id) }}"
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end " data-popper-placement="top-end"
                                            ...
                                            <li><a href="{{route('dashboard.fast-shipping.edit',$fastShipping->id)}}"
                                                   class="dropdown-item edit-item-btn"><i
                                                        class="ri-pencil-fill align-bottom me-2 text-muted"></i>
...
--}}{{--                                            </li> --}}{{--
                                ...
                                <!-- Start Delete Modal -->
                                <div class="modal fade flip" id="deleteFag-{{ $fastShipping->id }}" tabindex="-1"
                                    aria-hidden="true">
                                            ...
                                            <div class="modal-body p-5 text-center">
                                                ...
                                                <div class="mt-4 text-center">
                                                    ...
                                                    <div class="hstack gap-2 justify-content-center remove">
                                                        ...
                                                        <form
                                                            action="{{ route('dashboard.privacy-policy.destroy', $fastShipping->id) }}"
                                                            method="post">
                                                            @csrf
                                                            @method('DELETE')
