...
{{--
                    <a href="{{route('dashboard.clients.create')}}" class="btn btn-success">
                        <i class="ri-add-line align-bottom me-1"></i>@lang('admin.clients.add')</a>--}}
                </div>
                <div class="card-body">
                    <table id="buttons-datatables" class="display table table-bordered" style="width:100%">
                        <thead class="text-muted table-light">
                        <tr>
                            <th>@lang('admin.clients.id')</th>
                            <th>@lang('admin.clients.name')</th>
                                ...
                                <td>
                                    <div class="dropdown d-inline-block">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end " data-popper-placement="top-end"
                                            ...
                                            <li><a href="{{route('dashboard.clients.edit',$client->id)}}"
                                                   class="dropdown-item edit-item-btn"><i
                                                        class="ri-pencil-fill align-bottom me-2 text-muted"></i>
                                                    @lang('admin.edit')</a></li>
                                            <li><a href="{{route('dashboard.clients.show',$client->id)}}"
                                                   class="dropdown-item edit-item-btn"><i class="mdi mdi-package-variant"></i>
                                                    @lang('admin.clients.address_client')</a></li>
                                            <li class="list-inline-item" data-bs-toggle="tooltip"
                                                data-bs-trigger="hover" data-bs-placement="top"
                                                title="  @lang('admin.delete')">
                                                <a class="text-danger dropdown-item edit-item-btn"
                                                   data-bs-toggle="modal" href="#deleteCategory-{{ $client->id }}">
                                    ...
                                    <div class="modal-content">
                                        <div class="modal-body p-5 text-center">
                                            ...
                                            <div class="mt-4 text-center">
                                                <h4>@lang('admin.clients.delete_modal.title')</h4>
                                                <p class="text-muted fs-15 mb-4">@lang('admin.clients.delete_modal.description')</p>
