        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="{{route('dashboard.units.create')}}" class="btn btn-success">
                        <i class="ri-add-line align-bottom me-1"></i>@lang('admin.units.add')</a>
                </div>
                <div class="card-body">
                    <table id="buttons-datatables" class="display table table-bordered" style="width:100%">
                        <thead class="text-muted table-light">
                        <tr>
                            <th>@lang('admin.units.id')</th>
                            <th>@lang('admin.units.name')</th>
                        ...
                        @forelse($units as  $unit)
                            <tr>
                                <td>{{$unit->id}}</td>
                                <td>{{$unit->translations[0]->name}}</td>
                                ...
                                <td>
                                    <div class="dropdown d-inline-block">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end " data-popper-placement="top-end"
                                            ...
                                            <li><a href="{{route('dashboard.units.edit',$unit->id)}}"
                                            ...
                                            <li class="list-inline-item" data-bs-toggle="tooltip"
                                                ...
                                                <a class="text-danger dropdown-item edit-item-btn" data-bs-toggle="modal" href="#deleteCategory-{{ $unit->id }}">
                                        ...
                                        <div class="modal-body p-5 text-center">
                                            ...
                                            <div class="mt-4 text-center">
                                                ...
                                                <div class="hstack gap-2 justify-content-center remove">
                                                    ...
                                                    <form action="{{route('dashboard.units.destroy',$unit->id)}}"
                                                          method="post">
                                                        @csrf
                                                        @method("DELETE")
                                                        <button type="submit"
