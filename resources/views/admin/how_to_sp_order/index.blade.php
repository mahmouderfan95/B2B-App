            ...
            <div class="card">
                @if (count($data) == 0)
                    <div class="card-header">
                        ...
                        <a href="{{ route('dashboard.how-to-special-order.create') }}" class="btn btn-success">
                            <i class="ri-add-line align-bottom me-1"></i>@lang('admin.how-to-special-order.add')</a>
                    </div>
                @endif
                <div class="card-body">
                    <table id="buttons-datatables" class="display table table-bordered" style="width:100%">
                        <thead class="text-muted table-light">
                            <tr>
                                <th>@lang('admin.how-to-special-order.fast_shipping')</th>
                                <th>@lang('admin.actions')</th>
                            </tr>
                        </thead>
                        <tbody>

                            @forelse($data as  $howToSpecialOrder)
                                <tr>
                                    <td>{{ $howToSpecialOrder->translations[0]->content }}</td>

                                    <td>
                                        <a href="{{ route('dashboard.how-to-special-order.edit', $howToSpecialOrder->id) }}"
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end " data-popper-placement="top-end"
                                            ...
                                            <li><a href="{{route('dashboard.how-to-special-order.edit',$howToSpecialOrder->id)}}"
                                                   class="dropdown-item edit-item-btn"><i
                                                        class="ri-pencil-fill align-bottom me-2 text-muted"></i>
...
--}}{{--                                            </li> --}}{{--
                                ...
                                <!-- Start Delete Modal -->
                                <div class="modal fade flip" id="deleteFag-{{ $howToSpecialOrder->id }}" tabindex="-1"
                                    aria-hidden="true">
                                            ...
                                            <div class="modal-body p-5 text-center">
                                                ...
                                                <div class="mt-4 text-center">
                                                    ...
                                                    <div class="hstack gap-2 justify-content-center remove">
                                                        ...
                                                        <form
                                                            action="{{ route('dashboard.privacy-policy.destroy', $howToSpecialOrder->id) }}"
                                                            method="post">
                                                            @csrf
                                                            @method('DELETE')
