...
@section('content')
    ...
    <form>
        <div class="row g-3">
            ...
            <div class="col-xxl-4 col-sm-6">
                <div class="search-box">
                    <input name="created_at" type="date" class="form-control flatpickr-input active"
                                ...
                                <td>
                                    <div class="dropdown d-inline-block">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end " data-popper-placement="top-end"
                                            ...
                                            <li><a href="{{route('dashboard.special-orders.show',$order->id)}}"
                                        ...
                                        <div class="modal-body p-5 text-center">
                                            ...
                                            <div class="mt-4 text-center">
                                                ...
                                                <div class="hstack gap-2 justify-content-center remove">
                                                    ...
                                                    <form action="{{route('dashboard.special-orders.destroy',$order->id)}}"
                                                          method="post">
                                                        @csrf
                                                        @method("DELETE")
                                                        <button type="submit"
