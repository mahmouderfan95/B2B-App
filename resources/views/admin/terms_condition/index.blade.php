...
@section('title')
    @lang('admin.terms-conditions.page_title')
@endsection
@section('css')
    <!--datatable css-->
        ...
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-header">
                    ...
                    <a href="{{route('dashboard.terms-conditions.create')}}" class="btn btn-success">
                        <i class="ri-add-line align-bottom me-1"></i>@lang('admin.terms-conditions.add')</a>
                </div>
                @endif
                <div class="card-body">
                    <table id="buttons-datatables" class="display table table-bordered" style="width:100%">
                        ...
                        <tr>
                            <th>@lang('admin.terms-conditions.terms-conditions')</th>
                        ...
                        @forelse($data as  $policy)
                            <tr>
                                <td>{{$policy->translations[0]->term_and_condition}}</td>

                                <td>
                                    <a href="{{route('dashboard.terms-conditions.edit',$policy->id)}}"
                                    ...
                                    <div class="modal-content">
                                        <div class="modal-body p-5 text-center">
                                            ...
                                            <div class="mt-4 text-center">
                                                    <h4>@lang('admin.terms-conditions.delete_modal.title')</h4>
                                                    <p class="text-muted fs-15 mb-4">@lang('admin.terms-conditions.delete_modal.description')</p>
                                                <div class="hstack gap-2 justify-content-center remove">
                                                    ...
                                                    <form action="{{route('dashboard.terms-conditions.destroy',$policy->id)}}"
                                                          method="post">
                                                        @csrf
                                                        @method("DELETE")
                                                        <button type="submit"
