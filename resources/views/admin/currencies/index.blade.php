        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="{{route('dashboard.currencies.create')}}" class="btn btn-success">
                        <i class="ri-add-line align-bottom me-1"></i>@lang('admin.currencies.add')</a>
                </div>
                <div class="card-body">
                    <table id="buttons-datatables" class="display table table-bordered" style="width:100%">
                        <thead class="text-muted table-light">
                        <tr>
                            <th>@lang('admin.currencies.id')</th>
                            <th>@lang('admin.currencies.name')</th>
                            <th>@lang('admin.currencies.code')</th>
                            <th>@lang('admin.currencies.value')</th>
                        ...
                        @forelse($currencies as  $currency)
                                ...
                                <td>
                                    <div class="dropdown d-inline-block">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end " data-popper-placement="top-end"
                                            ...
                                            <li><a href="{{route('dashboard.currencies.edit',$currency->id)}}"
                                            ...
                                            <li class="list-inline-item" data-bs-toggle="tooltip"
                                                ...
                                                <a class="text-danger dropdown-item edit-item-btn" data-bs-toggle="modal" href="#deleteCategory-{{ $currency->id }}">
                                    ...
                                    <div class="modal-content">
                                        <div class="modal-body p-5 text-center">
                                            ...
                                            <div class="mt-4 text-center">
                                                <h4>@lang('admin.currencies.delete_modal.title')</h4>
                                                <p class="text-muted fs-15 mb-4">@lang('admin.currencies.delete_modal.description')</p>
                                                <div class="hstack gap-2 justify-content-center remove">
                                                    ...
                                                    <form action="{{route('dashboard.currencies.destroy',$currency->id)}}"
                                                          method="post">
                                                        @csrf
                                                        @method("DELETE")
                                                        <button type="submit"
                            ...
                            <!-- End Delete Modal -->
                        @empty
                            <tr><td>@lang('admin.empty_data')</td></tr>
                        @endforelse
                    </table>
                </div>
            </div>
