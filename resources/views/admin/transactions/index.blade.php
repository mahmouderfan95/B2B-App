...
@section('content')
    @component('components.breadcrumb')
        @slot('li_1')
            @lang('admin.transactions.transactions')
        @endslot
        @slot('title')
            @lang('admin.transactions.manage_transactions')
        @endslot
            ...
            <div class="card">
                <div class="card-body">
                    <table id="buttons-datatables" class="display table table-bordered" style="width:100%">
                        ...
                        <tr>
                            <th>@lang('admin.transactions.id')</th>
                            <th>@lang('admin.transactions.client')</th>
                            <th>@lang('admin.transactions.date')</th>
                            <th>@lang('admin.transactions.status')</th>
                            <th>@lang('admin.transactions.total')</th>
                            <th>@lang('admin.transactions.payment_method')</th>
                            <th>@lang('admin.transactions.code')</th>
                            <th>@lang('admin.transactions.products_count')</th>
                            <th>@lang('admin.transactions.use_wallet')</th>
                        ...
                        @forelse($transactions as  $transaction)
                            <tr>
                                ...
                                <td>{{$transaction->products_count}}</td>
                                <td> @if($transaction->use_wallet == '1')
                                        <span class="badge badge-soft-success">@lang('admin.yes')</span>
                                    @else
                                        <span class="badge badge-soft-danger">@lang('admin.no')</span>
                                    @endif
                                </td>
                                <td>
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end " data-popper-placement="top-end"
                                            ...
                                            <li class="list-inline-item" data-bs-toggle="tooltip"
                                                ...
                                                <a class="text-danger dropdown-item edit-item-btn"
                                                   data-bs-toggle="modal" href="#deleteCategory-{{ $transaction->id }}">
                            ...
                            <div class="modal fade flip"
                                 id="deleteCategory-{{ $transaction->id }}"
                                    ...
                                    <div class="modal-content">
                                        <div class="modal-body p-5 text-center">
                                            ...
                                            <div class="mt-4 text-center">
                                                <h4>@lang('admin.transactions.delete_modal.title')</h4>
                                                <p class="text-muted fs-15 mb-4">@lang('admin.transactions.delete_modal.description')</p>
