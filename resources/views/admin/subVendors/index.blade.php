    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            <div class="col-auto mb-4">
                <a href="{{route('dashboard.sub-vendors.create')}}">
                ...
                <div class="card-body">
                    <table id="buttons-datatables" class="display table table-bordered" style="width:100%">
                        ...
                        <tr>
                            ...
                            <th>@lang('vendor.sub.vendor_name')</th>
                                ...
                                <td>
                                    <div class="dropdown d-inline-block">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end " data-popper-placement="top-end"
                                            ...
                                            <li><a href="{{route('dashboard.sub-vendors.edit', $sub->id)}}"
                                        ...
                                        <div class="modal-body p-5 text-center">
                                            ...
                                            <div class="mt-4 text-center">
                                                ...
                                                <div class="hstack gap-2 justify-content-center remove">
                                                    ...
                                                    <form action="{{ route('dashboard.sub-vendors.destroy', $sub->id)  }}"
                                                          method="post">
                                                        @csrf
                                                        @method("DELETE")
                                                        <button type="submit"
