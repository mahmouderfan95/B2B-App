...
@section('content')
    ...
    @if (isset($agreement) && $agreement)
        <div class="modal fade bs-example-modal-xl" style="" tabindex="-1" role="dialog"
            aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-xl" style="max-height: 90vh">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="myExtraLargeModalLabel">
                            @lang('vendor.agreement-requested')
                            <a href="{{ $agreement->agreement_pdf }}" download>
                                @lang('vendor.download-agreement')
                            </a>
                        </h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body" style="max-height: 80vh; overflow-y: auto">
                        <embed src="{{ $agreement->agreement_pdf }}" type="application/pdf" width="100%" height="800" />
                    </div>
                    <div class="modal-footer">
                        <form action="{{ route('sub-vendor.agreements.approve') }}" method="post">
                            @csrf
                            @method('put')
                            <button class="btn btn-success">
                                @lang('vendor.agreement-read-and-approve')
                            </button>
                        </form>
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="flex-grow-1 overflow-hidden">
                                        <p class="text-uppercase fw-medium text-muted text-truncate mb-0">
                                            @lang('vendor.homepage.count_of_sample_orders')</p>
                                    </div>
                                </div>
                                <div class="d-flex align-items-end justify-content-between mt-4">
                                    <div>
                                        <h4 class="fs-22 fw-semibold ff-secondary mb-4"><span class="counter-value"
                                                data-target="{{ $sampleOrdersCount }}">0</span>
                                        </h4>
                                        <a href="{{ route('sub-vendor.orders.index') }}"
                                            class="link-secondary text-decoration-underline">@lang('vendor.homepage.count_of_sample_orders')</a>
                                    </div>
                        ...
                        <div class="card card-animate">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <div class="flex-grow-1 overflow-hidden">
                                        <p class="text-uppercase fw-medium text-muted text-truncate mb-0">
                                            @lang('vendor.homepage.count_of_public_orders')</p>
                                    </div>
                                </div>
                                <div class="d-flex align-items-end justify-content-between mt-4">
                                    <div>
                                        <h4 class="fs-22 fw-semibold ff-secondary mb-4"><span class="counter-value"
                                                data-target="{{ $publicOrdersCount }}">0</span></h4>
                                        <a href="{{ route('sub-vendor.orders.public') }}"
                                            class="link-secondary text-decoration-underline">@lang('vendor.homepage.count_of_public_orders')</a>
                                    </div>
                                    <div class="avatar-sm flex-shrink-0">
                                        <span class="avatar-title bg-soft-primary rounded fs-3">
                        ...
                        <div class="card card-animate">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <div class="flex-grow-1 overflow-hidden">
                                        <p class="text-uppercase fw-medium text-muted text-truncate mb-0">
                                            @lang('vendor.homepage.count_of_sp_orders')</p>
                                    </div>
                                </div>
                                <div class="d-flex align-items-end justify-content-between mt-4">
                                    <div>
                                        <h4 class="fs-22 fw-semibold ff-secondary mb-4"><span class="counter-value"
                                                data-target="{{ $spOrdersCount }}">0</span>
                                        </h4>
                                        <a href="{{ route('sub-vendor.orders.special') }}"
                                            class="link-secondary text-decoration-underline">@lang('vendor.homepage.count_of_sp_orders')</a>
                                    </div>
                                    <div class="avatar-sm flex-shrink-0">
                                        <span class="avatar-title bg-soft-primary rounded fs-3">
                        ...
                        <div class="card card-animate">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <div class="flex-grow-1 overflow-hidden">
                                        <p class="text-uppercase fw-medium text-muted text-truncate mb-0">
                                            @lang('vendor.homepage.count_of_products')</p>
                                    </div>
                                </div>
                                <div class="d-flex align-items-end justify-content-between mt-4">
                                    <div>
                                        ...
                                        <a href="{{ route('sub-vendor.products.index') }}"
                                            class="link-secondary text-decoration-underline">@lang('vendor.homepage.count_of_products')</a>
                                    </div>
                                    <div class="avatar-sm flex-shrink-0">
                                        <span class="avatar-title bg-soft-primary rounded fs-3">
                                            <i class="bx bx-wallet text-primary"></i>
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="card">
                            <div class="card-header align-items-center d-flex">
                                <h4 class="card-title mb-0 flex-grow-1">@lang('admin.homepage.best_selling_product')</h4>
                                                ...
                                                @foreach ($bestSellingProduct as $value)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <span class="text-muted">@lang('admin.products.price')</span>
                                                        </td>
                                                        <td>
                                                            <h5 class="fs-14 my-1 fw-normal">{{ $value->status }}</h5>
                                                            <span class="text-muted">@lang('admin.status')</span>
                                                        </td>
                                                        <td>
                                                            <h5 class="fs-14 my-1 fw-normal">{{ $value->quantity }}</h5>
                                                            <span class="text-muted">@lang('admin.products.quantity')</span>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                            @endif
                    ...
                    <div class="col-xl-12">
                        <div class="card card-height-100">
                            <div class="card-header align-items-center d-flex">
                                <h4 class="card-title mb-0 flex-grow-1">@lang('admin.homepage.latest_sample_order')</h4>
                            </div><!-- end card header -->
                        </div> <!-- .card-->
                    </div> <!-- .col-->
                </div> <!-- end row-->
                            ...
                            <div class="card-body">
                                <div class="table-responsive table-card">
                                    <table class="table table-borderless table-centered align-middle table-nowrap mb-0">
                                        ...
                                        <tbody>
                                            @if ($latestSampleOrder->count() > 0)
                                                @foreach ($latestSampleOrder as $value)
                                                    <tr>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <span
                                                                class="badge badge-soft-success">{{ $value->status ?? '' }}</span>
                                                        </td>
                                                    </tr><!-- end tr -->
                                                @endforeach
                                            @endif
