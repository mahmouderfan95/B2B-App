        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="{{route('sub-vendor.products.create')}}" class="btn btn-success">
                ...
                <div class="card-body">
                    <table id="buttons-datatables" class="display table table-bordered" style="width:100%">
                        ...
                        @forelse($products as  $product)
                            <tr>
                                <td>{{$product->id}}</td>
                                <td><img src="{{ $product->image }}" alt="{{ $product->name }}" height="70" width="50">
                                </td>
                                <td>
                                ...
                                <td>
                                    <div class="dropdown d-inline-block">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end " data-popper-placement="top-end"
                                            ...
                                            <li><a href="{{route('sub-vendor.products.edit',$product->id)}}"
                                        ...
                                        <div class="modal-body p-5 text-center">
                                            ...
                                            <div class="mt-4 text-center">
                                                ...
                                                <div class="hstack gap-2 justify-content-center remove">
                                                    ...
                                                    <form action="{{route('sub-vendor.products.destroy',$product->id)}}"
                                                          method="post">
                                                        @csrf
                                                        @method("DELETE")
                                                        <button type="submit"
