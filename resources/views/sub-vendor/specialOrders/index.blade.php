                                ...
                                <td>
                                    <div class="dropdown d-inline-block">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end " data-popper-placement="top-end"
                                            ...
                                            <li><a href="{{route('sub-vendor.orders.special.show',$order->id)}}"
                                                   class="dropdown-item edit-item-btn"><i
                                                        class="ri-eye-2-fill align-bottom me-2 text-muted"></i>
                                                    @lang('admin.show')</a></li>
                                            @if($order->status != \App\Enums\OrderStatus::ACCEPTED || $order->status == \App\Enums\OrderStatus::REGISTERD)
                                        ...
                                        <div class="modal-body p-5 text-center">
                                            ...
                                            <div class="mt-4 text-center">
                                                ...
                                                <div class="hstack gap-2 justify-content-center remove">
                                                    ...
                                                    <form action="{{route('sub-vendor.special-orders.destroy',$order->id)}}"
                                                          method="post">
                                                        @csrf
                                                        @method("DELETE")
                                                        <button type="submit"
...
{{--                                                <p class="text-muted fs-15 mb-4">@lang('admin.orders.delete_modal.description')</p>--}}
                                                <div class="hstack gap-2 justify-content-center remove">
                                                    <button
                                                        class="btn btn-link link-primary fw-medium text-decoration-none"
                                                        data-bs-dismiss="modal"
                                                        id="acceptRecord-close">
                                                        <i class="ri-close-line me-1 align-middle"></i>
                                                        @lang('admin.close')
                                                    </button>
                                                    <form action="{{route('vendor.orders.special.accepted',$order->id)}}"
                                                          method="post">
                                                        @csrf
                                                        @method("PUT")
                                                        <button type="submit"
