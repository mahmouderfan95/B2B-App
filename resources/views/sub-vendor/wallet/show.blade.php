                    ...
                    <div>
                        <div class="flex-shrink-0 avatar-md mx-auto">
                            <div class="avatar-title bg-light rounded">
                                <img src="{{ URL::asset(auth()->user()->vendor->logo) }}" alt="" height="50"/>
                            </div>
                        </div>
                        ...
                        <div class="table-responsive">
                            <table class="table mb-0 table-borderless">
                                <tbody>
                                <tr>
                                    <th><span class="fw-medium">@lang("admin.vendorWallets.user_vendor_name")</span>
                                    </th>
                                ...
                                <tr>
                                    ...
                                    <td style="font-weight:bold;color: #35b91e">{{ $vendorWallet->balance_in_sar  . ' ' . __('translation.sar') }}</td>
                                </tr>
        ...
        <div class="col-lg-9">
            <div class="card">
                ...
                <div class="card-footer">
                    <h5>
                        @lang("admin.vendorWallets.current_wallet_balance"): <span
                            style="font-weight:bold;color: #35b91e">{{ $vendorWallet->balance_in_sar . ' ' . __('translation.sar')}}</span>
                    </h5>
                </div>
            </div>
            <div class="card" id="wallets">
                ...
                <div class="card-body mb-3">
                    <form action="{{route('sub-vendor.wallet')}}">
                        <div class="row g-3">
                            <div class="col-xxl-3 col-sm-6">
                                <div>
                                    <input type="text" name="date_from" class="form-control" data-provider="flatpickr"
                                           data-date-format="Y-m-d" id="demo-datepicker"
                                           placeholder="@lang('translation.date_from')"
                            ...
                            <div class="col-xxl-3 col-sm-6">
                                <div>
                                    <input type="text" name="date_to" class="form-control" data-provider="flatpickr"
                                           data-date-format="Y-m-d" id="demo-datepicker"
                                           placeholder="@lang('translation.date_to')"
                            ...
                            <div class="col-xxl-2 col-sm-4">
                                <div>
                                    <a href="{{route('vendor.wallet')}}" type="reset" class="btn btn-secondary w-100">
                                        <i class=" ri-loader-3-line me-1 align-bottom"></i>
