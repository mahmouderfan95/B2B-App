            ...
            <div class="modal-content">
                ...
                @elseif ($order->status == App\Enums\OrderStatus::PAID30)
                    <div class="modal-body">
                        ...
                        <div class="col-sm-4">
                            <form action="{{ route('vendor.orders.public.readyForShip', $order->id) }}" method="post">
                                @csrf
                ...
                @elseif($order->status == App\Enums\OrderStatus::PAID)
                    <div class="modal-body">
                        ...
                        <div class="col-sm-4">
                            <form action="{{ route('vendor.orders.public.delivery', $order->id) }}" method="post">
                                @csrf
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-grow-1 ms-3">
                                                <h6 class="fs-14 mb-0 fw-semibold">
                                                    {{ \App\Enums\OrderStatus::getStatusWithClass($order->status)['name'] }}
                                                </h6>
                                            </div>
                                        </div>
                                    </a>
