                ...
                <div class="card-body">
                    <table id="buttons-datatables" class="display table table-bordered" style="width:100%">
                        <thead class="text-muted table-light">
                            <tr>
                                <th>@lang('vendor.order-quotations.id')</th>
                                <th>@lang('vendor.order-quotations.quotation_price')</th>
                                <th>@lang('vendor.order-quotations.expect_date_from')</th>
                                <th>@lang('vendor.order-quotations.expect_date_to')</th>
                                <th>@lang('vendor.order-quotations.status')</th>
                                <th>@lang('vendor.order-quotations.actions')</th>
                            </tr>
                        </thead>
                        <tbody>
                            @forelse($data as  $quotation)
                                <tr>
                                    <td>{{ $quotation->id }}</td>
                                    <td>{{ $quotation->quotation_price }}</td>
                                    <td>{{ date('d M Y', strtotime($quotation->expect_date_from)) }}</td>
                                    <td>{{ date('d M Y', strtotime($quotation->expect_date_to)) }}</td>
                                        ...
                                        <div class="dropdown d-inline-block">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end " data-popper-placement="top-end"
                                                ...
                                                @if ($quotation->status == 'pending')
                                                    <li>
                                                        <a href="{{ route('vendor.quotations.send.replay.page', $quotation->id) }}"
                                                            class="dropdown-item edit-item-btn"><i
                                                                class="ri-pencil-fill align-bottom me-2 text-muted"></i>
                                                            @lang('vendor.order-quotations.edit')</a>
                                                    </li>
                                                @endif
                                                <li class="list-inline-item" data-bs-toggle="tooltip"
                                                    ...
                                                    <a class="text-danger dropdown-item edit-item-btn"
                                                        data-bs-toggle="modal" href="#deleteCategory-{{ $quotation->id }}">
                                ...
                                <!-- Start Delete Modal -->
                                <div class="modal fade flip" id="deleteCategory-{{ $quotation->id }}" tabindex="-1"
                                    aria-hidden="true">
                                            ...
                                            <div class="modal-body p-5 text-center">
                                                ...
                                                <div class="mt-4 text-center">
                                                    ...
                                                    <div class="hstack gap-2 justify-content-center remove">
                                                        ...
                                                        <form
                                                            action="{{ route('dashboard.orders.destroy', $quotation->id) }}"
                                                            method="post">
                                                            @csrf
                                                            @method('DELETE')
