    ...
    <div id="myModal" class="modal fade" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                @if ($specialOrder->status == App\Enums\OrderStatus::REGISTERD)
                    <div class="modal-body">
                        {{-- <h5 class="fs-15"> Overflowing text to show scroll behavior </h5> --}}
                        <div class="row">
                            <div class="col-sm-2">
                                <form action="{{ route('vendor.orders.special.accepted', $specialOrder->id) }}"
                                    method="post">
                                    @csrf
                            ...
                            <div class="col-sm-2">
                                <form action="{{ route('vendor.orders.special.reject', $specialOrder->id) }}"
                                    method="post">
                                    @csrf
                ...
                @elseif ($specialOrder->status == App\Enums\OrderStatus::PAID30)
                    <div class="modal-body">

                        <div class="col-sm-4">
                            <form action="{{ route('vendor.orders.special.readyForShip', $specialOrder->id) }}"
                                method="post">
                                @csrf
                ...
                @elseif($specialOrder->status == App\Enums\OrderStatus::PAID)
                    <div class="modal-body">

                        <div class="col-sm-4">
                            <form action="{{ route('vendor.orders.special.delivery', $specialOrder->id) }}" method="post">
                                @csrf
                                <button class="btn btn-success" type="submit"> @lang('admin.btn.delivery') </button>
                            </form>
                        </div>
                    </div>
                @endif
                ...
                <div class="card-header">
                    <div class="d-sm-flex align-items-center">
                        ...
                        <div class="flex-shrink-0 mt-2 mt-sm-0">
                            <a href="javasccript:void(0;)" class="btn btn-soft-primary btn-sm mt-2 mt-sm-0" type="button"
