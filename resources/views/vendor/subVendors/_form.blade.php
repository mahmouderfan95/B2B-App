...
<div class="col-md-6">
    <x-form.input type="text" name="name" value="{{$subVendor->name ?? ''}}" label="{{ trans('vendor.sub.name') }}" required />
</div>

<div class="col-md-6">
    <x-form.input type="email" name="email" value="{{$subVendor->email ?? ''}}" label="{{ trans('admin.vendors.email') }}" required />
</div>

<div class="col-md-6">
    <x-form.input type="number" name="phone" value="{{$subVendor->phone ?? ''}}" label="{{ trans('admin.vendors.phone') }}" required />
</div>
