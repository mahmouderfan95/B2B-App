    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            <div class="col-auto mb-4">
                <a href="{{route('vendor.sub.create.form')}}">
                ...
                <div class="card-body">
                                    ...
                                    <td>
                                        <div class="dropdown d-inline-block">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end " data-popper-placement="top-end"
                                                ...
                                                <li><a href="{{route('vendor.sub.edit.form', $sub->id)}}"
                                            ...
                                            <div class="modal-body p-5 text-center">
                                                ...
                                                <div class="mt-4 text-center">
                                                    ...
                                                    <div class="hstack gap-2 justify-content-center remove">
                                                        ...
                                                        <form action="{{ route('vendor.sub.delete', $sub->id)  }}"
                                                              method="post">
                                                            @csrf
                                                            @method("DELETE")
                                                            <button type="submit"
                    ...
                    @else
                        <div class="text-center">
                            ...
                            <a  href="{{ route('vendor.sub.create.form') }}">@lang('vendor.sub.addNewVendor')</a>
                        </div>
                    @endif
                </div>
            </div>
