        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table id="attribute" class="table table-bordered dt-responsive nowrap table-striped align-middle">
                        <thead>
                        <tr>
...
@section('script')
    ...
    <script type="text/javascript"><!--
        ...
        function addAttribute() {
            ...
            @forelse($languages as  $language)
                html += '<div class="input-group"><span class="input-group-addon">({{$language->name}})</span><textarea name="product_attribute[' + attribute_row + '][product_attribute_description][{{ $language->id }}][text]" rows="5" placeholder="@lang('admin.products.entry_text')" class="form-control"></textarea></div>';
            @empty
                @endforelse
                html += '  </td>';
    ...
    <script type="text/javascript">
        ...
        var dropzone = new Dropzone(".dropzone", {
            url: '/vendor/dashboard/upload-image',
            method: "POST",
