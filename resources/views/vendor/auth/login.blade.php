                ...
                <div class="col-md-8 col-lg-6 col-xl-5">
                    <div class="card mt-4">
                        ...
                        <div class="card-body p-4">
                            ...
                            <p class="text-muted">
                                @if(Session::has('inactive_vendor'))
                                    <p style="color: red !important;">
                                        {{ __(Session::get('inactive_vendor')) }}
                                        <a class="mt-1" href="mailto:support@domain.com">support@domain.com</a>
                                    </p>
                                @else
                            ...
                            <div class="p-2 mt-4">
                                <form action="{{ route('vendor.login') }}" method="POST">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('phone') is-invalid @enderror" value="{{ old('phone', '5344704757') }}" id="username" name="phone" placeholder="01XXXXXXXXXX">
                                        @error('phone')
