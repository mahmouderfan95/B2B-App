                    ...
                    <div class="card card-animate">
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-end justify-content-between mt-4">
                                <div>
                                    <h4 class="fs-22 fw-semibold ff-secondary mb-4"><span class="counter-value" data-target="{{ $sampleOrdersCount }}">0</span>
                                    </h4>
                ...
                <div class="col-xl-3 col-md-6">
                    ...
                    <div class="card card-animate">
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-end justify-content-between mt-4">
                                <div>
                                    <h4 class="fs-22 fw-semibold ff-secondary mb-4"><span class="counter-value" data-target="{{ $publicOrdersCount }}">0</span></h4>
                ...
                <div class="col-xl-3 col-md-6">
                    ...
                    <div class="card card-animate">
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-end justify-content-between mt-4">
                                <div>
                                    <h4 class="fs-22 fw-semibold ff-secondary mb-4"><span class="counter-value" data-target="{{ $spOrdersCount }}">0</span>
                                    </h4>
                ...
                <div class="col-xl-3 col-md-6">
                    ...
                    <div class="card card-animate">
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-end justify-content-between mt-4">
                                <div>
                                    <h4 class="fs-22 fw-semibold ff-secondary mb-4"><span class="counter-value" data-target="{{ $productsCount }}">0</span>
                                    </h4>
                ...
                <div class="col-xl-6">
                    <div class="card">
                        <div class="card-header align-items-center d-flex">
                            <h4 class="card-title mb-0 flex-grow-1">Latest Products</h4>
                        </div><!-- end card header -->
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div>
                                                                <h5 class="fs-14 my-1"><a href="{{URL::asset('/apps-ecommerce-product-details')}}" class="text-reset">{{$product->name ?? ''}}</a></h5>
                                ...
                                <table class="table table-borderless table-centered align-middle table-nowrap mb-0">
                                    ...
                                    <tbody>
                                        @if($latestSampleOrder->count() > 0)
                                            @foreach($latestSampleOrder as $order)
                                                <tr>
                                                    <td>
                                                        <a href="{{URL::asset('/apps-ecommerce-order-details')}}" class="fw-medium link-primary">#{{$order->id ?? ''}}</a>
                                                    </td>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="flex-shrink-0 me-2">
                                                                <img src="{{ $order?->client->Image }}" alt="" class="avatar-xs rounded-circle" />
                                                            </div>
                                                            <div class="flex-grow-1">{{$order->client?->name}}</div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <span class="">{{$order->vendor?->name ?? ''}}</span>
                                                    </td>
                                                    <td>
