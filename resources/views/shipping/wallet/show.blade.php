    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="card">
                ...
                <div class="card-body">
                    <h5 class="card-title flex-grow-1 mb-0">@lang('admin.shippingWallets.shipping_method') :  {{$shippingWallet->shipping_method->translations[0]->name}} </h5>
                    <h5 class="card-title flex-grow-1 mb-0">@lang('admin.shippingWallets.balance') :  {{$shippingWallet->balance}} </h5>
                    <hr>
