...
@section('content')
    ...
    <div class="row">
        <div class="col-xl-9">
            ...
            <!-- Button trigger modal -->
            @if ($order->status == 'accepted_by_vendor' && $order->shipping_method == 'cif')
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="{{ route('shipping.public-orders.add.offer') }}" method="POST">
                                @csrf
                                ...
                                <div class="mb-3">
                                    ...
                                    <input required="required" name="price" type="number" class="form-control"
                                        ...
                                        placeholder="{{ trans('admin.shippingMethods.offer_price') }}">
                                </div>
                                <div class="mb-3">
                                    <label for="exampleFormControlInput2" class="form-label">@lang('admin.shippingMethods.expect_date_from')</label>
                                    <input required="required" name="expect_date_from" type="date"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input required="required" name="expect_date_to" type="date" class="form-control"
