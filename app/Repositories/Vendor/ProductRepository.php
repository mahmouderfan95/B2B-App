...
class ProductRepository extends BaseRepository
{
    ...
    public function __construct(Application $app, ProductTranslationRepository $productTranslationRepository)
    {
    ...
    {
        return $this->model->where('vendor_id', auth()->user()->id)->get();
    }
    ...
    public function getAllCategoriesForm(): \Illuminate\Database\Eloquent\Collection
    {
        ...
        return Product::query()
            ...
            ->where('parent_id', null)->where('parent_id', null)->get();
