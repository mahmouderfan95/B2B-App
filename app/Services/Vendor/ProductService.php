...
class ProductService
{
    ...
    public function create(): \Illuminate\Contracts\View\View|\Illuminate\Contracts\View\Factory|\Illuminate\Http\JsonResponse|\Illuminate\Contracts\Foundation\Application
    {
        try {
            ...
            return view("vendor.products.create", compact('categories', 'attributes', 'attribute_row', 'languages', 'certificates', 'types', 'units', 'vendors', 'qualities', 'packages', 'sizes'));
        } catch (Exception $e) {
    ...
    public function storeProduct(ProductRequest $request)
    {
        ...
        if (auth()->guard('vendor')->check())
            $data_request['vendor_id'] = auth()->guard('vendor')->user()->id;
        ...
        try {
            ...
            if ($product) {
                DB::commit();
                return redirect()->route('vendor.products.index')->with('success', true);
            }
        } catch (Exception $e) {
            DB::rollBack();
    ...
    public function edit($id)
    {
        ...
        try {
            ...
            return view("vendor.products.edit", compact('categories', 'product_languages', 'product_attribute', 'attributes', 'attribute_row', 'product', 'product_certificates', 'languages', 'certificates', 'types', 'units', 'vendors', 'qualities', 'packages', 'sizes'));
        } catch (Exception $e) {
